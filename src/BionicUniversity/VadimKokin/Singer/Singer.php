...
class Singer
{
    ...
    public function Sing($GroupName)
    {
        ...
        if ($this->CheckGroup($GroupName) === false) {
            ...
            spl_autoload_register(function ($GroupName) {
                ...
                include '/var/www/bionic2/src/BionicUniversity/VadimKokin/Singer/Groups/' . str_replace(' ', '', $GroupName) . '.php';
    ...
    {
        $filenames = [];
        if ($handle = opendir('/var/www/bionic2/src/BionicUniversity/VadimKokin/Singer/Groups/')) {
